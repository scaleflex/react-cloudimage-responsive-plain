...
import { BackgroundImg, Img } from '../../../src';
  ...
  return (
    <div>
      <section className="home">
        <div className="container">
          ...
          <div className="reference-buttons">
            <a
              ...
              target="_blank"
              href="https://github.com/Scaleflex/react-cloudimage-responsive-plain/subscription"
              data-icon="octicon-eye"
              aria-label="Watch Scaleflex/react-cloudimage-responsive-plain on GitHub"
              rel="noreferrer"
            >
              Watch
            ...
            <a
              ...
              aria-label="Star Scaleflex/react-cloudimage-responsive-plain on GitHub"
              rel="noreferrer"
            >
              Star
            ...
            <a
              ...
              aria-label="Fork Scaleflex/react-cloudimage-responsive-plain on GitHub"
              rel="noreferrer"
            >
              Fork
        ...
        <a href="https://github.com/scaleflex/react-cloudimage-responsive-plain" target="_blank" rel="noreferrer">
          <img
          ...
          <div className="row">
            <div className="col-md-6 col-lg-7">
              ...
              <small>
                ...
                {' '}
                <a
                  href={`hhttps://cdn.scaleflex.it/demo/${images[18].src}`}
                  target="_blank"
                  rel="noreferrer"
                >
                  link
          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <div>
                ...
                >
                  <img alt="boat" src="https://doc.cloudimg.io/sample.li/boat.jpg" />
  ...
  render(<App />, document.body);`}
            ...
            <div className="action-wrapper forth-action">
              <p>
                ...
                {' '}
                <a
                  href="https://github.com/scaleflex/react-cloudimage-responsive-plain#table-of-contents"
                  target="_blank"
                  rel="noreferrer"
                >
                  {' '}
            ...
            <div className="row">
              ...
              <div className="footer-menu col-sm-3">
                <ul>
                  ...
                  <li>
                    <a href="https://github.com/scaleflex/react-cloudimage-responsive-plain/issues" target="_blank" rel="noreferrer">
                      Current
                      Issues
                    </a>
                  </li>
